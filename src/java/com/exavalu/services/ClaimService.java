...
/**
 *Service Class for Claims that stores all the business logics in terms of adding data to database, updating the database and read data from the database
 * @author Srabana
 */
